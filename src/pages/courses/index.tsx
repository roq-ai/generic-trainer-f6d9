            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>name</Th>
                  <Th>url</Th>
                  {hasAccess('trainer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>trainer</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('trainer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/trainers/view/${record.trainer?.id}`}>
                          {record.trainer?.name}
                        </Link>
                      </Td>
                    )}
